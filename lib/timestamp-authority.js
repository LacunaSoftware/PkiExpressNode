...
const { TimestampAuthorityAuthType } = require('./timestamp-authority-auth-type');
...
class TimestampAuthority {
	...
	addCmdArguments(args, versionManager = null) {
		args.push('--tsa-url');
		args.push(this._url);
		...
		case 'OAuthToken':
			...
			break;
		default:
			throw new Error('Unknown authentication type of the timestamp authority');
		}
